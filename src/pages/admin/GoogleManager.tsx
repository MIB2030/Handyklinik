...
export default function GoogleManager() {
  ...
  return (
    <div>
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-4">Google Reviews</h1>
        <p className="text-gray-600">Verwalten Sie Google Bewertungen und API-Einstellungen</p>
      </div>
