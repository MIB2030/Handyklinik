...
const DatenschutzFallback = () => (
  <div className="space-y-8">
    <section>
      <h2 className="text-2xl font-bold text-gray-900 mb-4">1) Einleitung und Kontaktdaten des Verantwortlichen</h2>
      <div className="space-y-4">
        <p className="text-gray-700 leading-relaxed">
          <span className="font-semibold">1.1</span> Wir freuen uns, dass Sie unsere Website besuchen, und bedanken uns für Ihr Interesse. Im Folgenden informieren wir Sie über den Umgang mit Ihren personenbezogenen Daten bei der Nutzung unserer Website. Personenbezogene Daten sind hierbei alle Daten, mit denen Sie persönlich identifiziert werden können.
        </p>
        <p className="text-gray-700 leading-relaxed">
          <span className="font-semibold">1.2</span> Verantwortlicher für die Datenverarbeitung auf dieser Website im Sinne der Datenschutz-Grundverordnung (DSGVO) ist MNW Mobilfunk GmbH, Unterhachingerstraße 28, 85521 Ottobrunn, Deutschland, Tel.: 08963286944, E-Mail: <a href="mailto:info@mnw-mobilfunk.de" className="text-blue-600 hover:underline">info@mnw-mobilfunk.de</a>. Der für die Verarbeitung von personenbezogenen Daten Verantwortliche ist diejenige natürliche oder juristische Person, die allein oder gemeinsam mit anderen über die Zwecke und Mittel der Verarbeitung von personenbezogenen Daten entscheidet.
        </p>
      </div>
    </section>

    <section>
      <h2 className="text-2xl font-bold text-gray-900 mb-4">2) Datenerfassung beim Besuch unserer Website</h2>
      <div className="space-y-4">
        <div>
          <p className="text-gray-700 leading-relaxed mb-4">
            <span className="font-semibold">2.1</span> Bei der bloß informatorischen Nutzung unserer Website, also wenn Sie sich nicht registrieren oder uns anderweitig Informationen übermitteln, erheben wir nur solche Daten, die Ihr Browser an den Seitenserver übermittelt (sog. „Server-Logfiles"). Wenn Sie unsere Website aufrufen, erheben wir die folgenden Daten, die für uns technisch erforderlich sind, um Ihnen die Website anzuzeigen:
          </p>
        ...
        <div>
          <p className="text-gray-700 leading-relaxed">
            <span className="font-semibold">2.2</span> Diese Website nutzt aus Sicherheitsgründen und zum Schutz der Übertragung personenbezogener Daten und anderer vertraulicher Inhalte (z.B. Bestellungen oder Anfragen an den Verantwortlichen) eine SSL-bzw. TLS-Verschlüsselung. Sie können eine verschlüsselte Verbindung an der Zeichenfolge „https://" und dem Schloss-Symbol in Ihrer Browserzeile erkennen.
          </p>
        </div>
      </div>
    </section>
    ...
    <section>
      <h2 className="text-2xl font-bold text-gray-900 mb-4">3) Hosting & Content-Delivery-Network</h2>
      <div className="space-y-4">
        <div>
          <p className="text-gray-700 leading-relaxed">
            <span className="font-semibold">3.1</span> Für das Hosting unserer Website und die Darstellung der Seiteninhalte nutzen wir einen Anbieter, der seine Leistungen selbst oder durch ausgewählte Sub-Unternehmer ausschließlich auf Servern innerhalb der Europäischen Union erbringt.
          </p>
        ...
        <div>
          <h3 className="text-xl font-semibold text-gray-900 mb-3">3.2 Cloudflare</h3>
          <p className="text-gray-700 leading-relaxed">
    ...
    <section>
      ...
      <div className="space-y-4">
        <div>
          <h3 className="text-xl font-semibold text-gray-900 mb-3">4.1 WhatsApp-Business</h3>
          <p className="text-gray-700 leading-relaxed">
        ...
        <div>
          <p className="text-gray-700 leading-relaxed">
            <span className="font-semibold">4.2</span> Im Rahmen der Kontaktaufnahme mit uns (z.B. per Kontaktformular oder E-Mail) werden personenbezogene Daten erhoben. Welche Daten im Falle der Nutzung eines Kontaktformulars erhoben werden, ist aus dem jeweiligen Kontaktformular ersichtlich. Diese Daten werden ausschließlich zum Zweck der Beantwortung Ihres Anliegens bzw. für die Kontaktaufnahme und die damit verbundene technische Administration gespeichert und verwendet.
          </p>
          <p className="text-gray-700 leading-relaxed mt-2">
    ...
    <section>
      <h2 className="text-2xl font-bold text-gray-900 mb-4">5) Seitenfunktionalitäten</h2>
      <div>
        ...
        <p className="text-gray-700 leading-relaxed mt-2">
          Weitere Hinweise zum Datenschutz von Google finden sich hier: <a href="https://business.safety.google/intl/de/privacy/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">https://business.safety.google/intl/de/privacy/</a>
        </p>
      </div>
    </section>

    <section>
      <h2 className="text-2xl font-bold text-gray-900 mb-4">6) Rechte des Betroffenen</h2>
      <div className="space-y-4">
        <div>
          <p className="text-gray-700 leading-relaxed mb-3">
            <span className="font-semibold">6.1</span> Das geltende Datenschutzrecht gewährt Ihnen gegenüber dem Verantwortlichen hinsichtlich der Verarbeitung Ihrer personenbezogenen Daten die nachstehenden Betroffenenrechte (Auskunfts- und Interventionsrechte), wobei für die jeweiligen Ausübungsvoraussetzungen auf die angeführte Rechtsgrundlage verwiesen wird:
          </p>
          <ul className="list-disc list-inside text-gray-700 leading-relaxed space-y-2 ml-4">
        ...
        <div>
          <h3 className="text-xl font-semibold text-gray-900 mb-3 uppercase">6.2 Widerspruchsrecht</h3>
          <div className="bg-gray-50 border-l-4 border-gray-900 p-4 space-y-3">
    ...
    <section>
      <h2 className="text-2xl font-bold text-gray-900 mb-4">7) Dauer der Speicherung personenbezogener Daten</h2>
